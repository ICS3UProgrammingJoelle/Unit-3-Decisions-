 ...
 * This program will converts 2 individual unicode values, 
 * upper case and lower case, into their appropriate character 
 * value, using a nested loop. It then displays both types of 
 * unicode characters (upper case and lower case) in the listbox.
*/
using System;
